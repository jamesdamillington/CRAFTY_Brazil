 ...
 * 
 */
public class AgriPropagation implements CapitalUpdateFunction {
	...
	public AgriPropagation() {
	};

	public AgriPropagation(Capital c, double change) {
		this.capital = c;
		this.change = change;
	}

	public AgriPropagation(Capital c, double change, double top, double bottom) {
		this(c, change);
		this.top = top;
		this.bottom = bottom;
	}
