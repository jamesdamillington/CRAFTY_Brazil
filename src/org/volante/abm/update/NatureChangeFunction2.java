 ...
 * 
 */
public class NatureChangeFunction2 implements CapitalUpdateFunction {
	...
	public NatureChangeFunction2() {
	};

	public NatureChangeFunction2(Capital c, double change) {
		this.capital = c;
		this.change = change;
	}

	public NatureChangeFunction2(Capital c, double change, double top, double bottom) {
		this(c, change);
		this.top = top;
		this.bottom = bottom;
	}
	...
	public void apply(Cell c, Region region, String year) {
		 ...
		 if(c.getBaseCapitals().getDouble(capital)<bottom){//if specified capital is below the bottom value (specified also in function declaration
